...
export default function HeroSlider() {
  const slides = [
    ...
    },
    {
      ...
      description: "Get personalized care from our panel of board-certified surgeons.",
      ctaPrimary: "Find A Doctor",
      ctaPrimaryPath: "/doctors",
      ctaSecondary: "Emergency Call",
      ctaSecondaryPath: "tel:+919030597575"
    },
    {
      image: advancedtech,
      tagline: "NEXT-GENERATION TECH",
      title: "Advanced Ophthalmic Technology for Cataract and Retina Services",
      description: "Equipped with high-precision visual acuity scanners, digital fundus cameras, and automated diagnostic systems.",
    ...
    },
    {
      ...
      description: "Rest easy in post-operative recovery suites with dedicated daytime nursing care, designed to provide a warm and calm healing environment.",
      ctaPrimary: "Book Appointment",
      ctaPrimaryPath: "/appointment",
    ...
    description: "Equipped for immediate stabilization, accidental eye injury management.",
    ctaPrimary: "Call Clinic Hotline",
    ctaPrimaryPath: "tel:+919030597575",
