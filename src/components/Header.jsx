    ...
    <header className="w-full z-50">
      ...
      <div className="bg-medical-dark text-white text-xs py-1.5 px-3 md:px-6 flex flex-wrap justify-between items-center gap-2 border-b border-white/10">
        <div className="flex flex-wrap items-center gap-4 md:gap-6">
          {/* <a href="tel:+919030597575" className="flex items-center gap-1.5 hover:text-emerald-accent transition-colors">
            <FaPhoneAlt className="text-emerald-accent" />
            <span className="font-semibold">Emergency:</span> +91 903 059 7575
          </a> */}
          <a href="tel:108" className="flex items-center gap-1.5 hover:text-red-400 transition-colors animate-pulse">
            ...
            <span className="font-semibold text-red-400">Emergency:</span> +91 903 059 7575
          </a>
        ...
        <div className="flex items-center gap-4">
          <a href="tel:+919030597575" className="bg-emerald-accent/20 text-emerald-accent px-3 py-1 rounded-full font-semibold border border-emerald-accent/30 hover:bg-emerald-accent hover:text-white transition-all text-[11px]">
            Call Now
          </a>
        ...
        <div className={`fixed inset-0 z-40 bg-medical-dark transition-all duration-300 xl:hidden ${
          ...
          <div className="flex flex-col h-full bg-white text-slate-800 p-6 pt-24 overflow-y-auto">
            ...
            <div className="mt-8 space-y-4 border-t border-slate-100 pt-6">
              ...
              >
                Emergency Call: +91 903 059 7575
              </a>
            </div>
          </div>
        </div>
